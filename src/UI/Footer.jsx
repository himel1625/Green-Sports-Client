...
const Footer = () => {
  return (
    <footer className="bg-gray-200 text-gray-800 py-12 px-6 md:px-16">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        <div className="space-y-4">
        ...
        <div>
          ...
          <div className="space-y-4">
            <textarea
              className="w-full p-4 bg-gray-200 text-gray-800 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-green-500 shadow-md"
              rows="2"
              placeholder="Share your valuable feedback..."
            />
            <button
