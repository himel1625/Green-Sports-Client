        ...
        <div className='w-full max-w-md md:max-w-lg lg:max-w-xl mx-auto  rounded-lg shadow-md p-6'>
          ...
          <div className='flex gap-10'>
            <button
              ...
              className='mt-6 w-full py-3 bg-Color text-white text-sm md:text-base rounded-md hover:bg-Color focus:outline-none focus:ring-2 focus:ring-Color transition duration-300'
            >
              Update Profile
            </button>
            <button
